 ...
 * the refinement step
 */
//TODO use list instead of strings -> test results and performace!
...
//		GraphTools.addRandomGraph(28, 30, g);
//		LabeledGraph<String, String> lg = GraphTools.createRandomStringLabeling(g, 2, 2);
//		
//		GraphFrame.createGraphFrame(lg);
//		
//		WeisfeilerLehmanRefiner<String> wlr = new WeisfeilerLehmanRefiner<String>();
//		LabeledGraph<String, String> lg2 = wlr.refineGraph(lg);
//		
//		GraphFrame.createGraphFrame(lg2);
//		
//		LabeledGraph<String, String> lg3 = wlr.refineGraph(lg2);
//		GraphFrame.createGraphFrame(lg3);
//	}
